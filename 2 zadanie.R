##Находкина Владлена Васильевна для дневных данных за лето 2019 года, постройте регрессионную зависимость скорости сокотечения переменная flux 
##для деревьев возрастом выше III 
